        ...
        for (let i = 0; i < rows; i++) {
            ...
            for (let j = 0; j < columns; j++) {
                ...
                img.addEventListener('contextmenu', e => {
                    ...
                    if (img.src == "http://127.0.0.1:5500/Buscaminas/img/negro.png") {
                        if (contadorBandera < numMinas) {
                            img.src = "img/negroBandera.png";
                            contadorBandera++;
                        }
                        $('p').text(`Minas restantes: ${numMinas-contadorBandera}`)
                    } else if (img.src == "http://127.0.0.1:5500/Buscaminas/img/negroBandera.png") {
